...
urlpatterns = [
    ...
    path(
        'adoption/reservations/<int:pk>/confirm/',
        views.confirm_adoption_reservation,
        name='adoption_confirm_reservation',
    ),
    ...
    path(
        'staff/adoption/<int:pk>/schedule/',
        views.schedule_adoption,
        name='adoption_schedule',
    ),
    path(
